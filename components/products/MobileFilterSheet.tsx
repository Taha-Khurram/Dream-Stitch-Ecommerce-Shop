  ...
  return (
    <>
      <button
        ...
        className="eyebrow flex cursor-pointer items-center gap-2 text-ink transition-colors hover:text-purple lg:hidden"
      >
        ...
        <div className="fixed inset-0 z-[70] lg:hidden">
          ...
          <div className="absolute inset-y-0 right-0 flex w-[88%] max-w-sm flex-col bg-white">
            ...
            <div className="border-t border-line p-5">
              <button onClick={() => setOpen(false)} className="btn-primary w-full cursor-pointer">
                Show Results
              </button>
            </div>
          </div>
